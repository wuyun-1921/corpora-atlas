...
**Platform:** Linux (Wayland). Requires `wl-paste` (clipboard) and `wlrctl` (window focus). <small>(macOS/Windows feasible with native clipboard APIs — not planned, straightforward port.)</small>
